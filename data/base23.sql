...
-- Tiempo de generación: 28-11-2023 a las 01:19:33
...
INSERT INTO `matriculas` (`idMatricula`, `fecha`, `idEstudiante`, `idCurso`, `idUsuario`) VALUES
(1, '2023-11-27', 12, 3, 2),
(2, '2023-11-20', 9, 4, 1);
...
(2, 'cliente', '$2y$10$3z.b3XAFyzOvEcyoIFIvw.a2xjDb66c36smUESWJ8AU7.TgT6l8/S', 1);
...
--
ALTER TABLE `matriculas`
  MODIFY `idMatricula` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
